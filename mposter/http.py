...
def get_proxies(errors: int = -1, paid_errors: int = 5, paid_type: int = -1, paid_check_host: str = '',
    ...
    try:
        if errors < paid_errors:
            ...
            return {'http': 'http://do-worker01p.sn-offline.com:12200',
                    'https': 'http://do-worker01p.sn-offline.com:12200'}
        else:
            return {'http': f'http://do-worker01p.sn-offline.com:12200',
                    'https': f'http://do-worker01p.sn-offline.com:12200'}
